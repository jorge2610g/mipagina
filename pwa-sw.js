const YUMMYPRO_CLIENT_CACHE="yummypro-client-v1620";
...
self.addEventListener("push",event=>{
 ...
 event.waitUntil((async()=>{
  ...
  const options={body:data.body||"Tienes una actualización.",icon:"/pwa-icon.svg",badge:"/icon-192.png",tag:data.tag||"yummypro-notification",renotify:true,silent:!!data.silent,requireInteraction:!!data.requireInteraction,data:{url:data.url||"/"}};
