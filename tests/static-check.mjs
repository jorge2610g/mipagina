...
for(const marker of ['pwa-install-btn','installCustomerPwa','yummypro_last_restaurant','/manifest.webmanifest?v=1622','/pwa-sw.js','yummypro_client_pwa_identity_v1622','customer-pwa-v1623','Versión v1.6.26'])if(!html.includes(marker))throw new Error('Falta PWA cliente actual: '+marker);
...
for(const marker of ['yummypro-client-v1626-professional-payment','SKIP_WAITING','/offline.html','/icon-192.png','/icon-512.png'])if(!pwaSw.includes(marker))throw new Error('Service Worker PWA cliente v1.6.25 incompleto: '+marker);
