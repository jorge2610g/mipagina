...
for(const marker of ['manifest.webmanifest','pwa-install-btn','installCustomerPwa','yummypro_last_restaurant','Versión v1.6.15'])if(!html.includes(marker))throw new Error('Falta PWA cliente: '+marker);
