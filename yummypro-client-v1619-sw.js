const YUMMYPRO_CLIENT_CACHE="yummypro-client-v1619";
const CLIENT_CORE=["/offline.html","/yummypro-client-v1619.webmanifest","/icon-192.png","/icon-512.png","/apple-touch-icon.png"];
